...
public class Arrow : MonoBehaviour
{
   ...
   */
    ...
    void OnGUI()
    {
        ...
        xPos = v * Mathf.Cos(theta) * (tT);
        yPos = v * Mathf.Sin(theta) * (tT) - 0.5f * g * (tT) * (tT);
        dist = (int) Mathf.Sqrt(xPos * xPos + yPos * yPos);
        ...
        GUI.Box(new Rect(5, 65, 100, 30), "theta = " + rotation);
        
        GUI.Box(new Rect(5, 95, 100, 30), "dist = " + dist);
